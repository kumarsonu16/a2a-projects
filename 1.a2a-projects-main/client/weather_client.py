"""
The client follows the standard A2A workflow:

1. Discovers the agent by calling the well-known endpoint
2. Creates A2A tasks with unique IDs and proper message structure
3. Sends tasks to the /tasks/send endpoint
4. Extracts responses from the A2A message format
"""

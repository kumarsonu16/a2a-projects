...
1. Serves an agent card at /.well-known/agent.json so clients can discover it
2. Handles tasks at /tasks/send with proper A2A message structure
3. Uses Tavily to gather real-time weather data
4. Leverages Gemini to create concise, well-formatted weather summaries
5. Returns formatted responses that include both the original message and the AI-enhanced reply
"""
